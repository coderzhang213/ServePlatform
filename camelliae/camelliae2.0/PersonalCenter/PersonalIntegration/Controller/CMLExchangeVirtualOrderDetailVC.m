//
//  CMLExchangeVirtualOrderDetailVC.m
//  camelliae2.0
//
...
@interface CMLExchangeVirtualOrderDetailVC ()<NavigationBarProtocol,NetWorkProtocol>
...
@implementation CMLExchangeVirtualOrderDetailVC
...
- (void) loadViews{
    ...
    [NetWorkTask setImageView:serveImage WithURL:self.obj.retData.goodsInfo.coverPic placeholderImage:nil];
