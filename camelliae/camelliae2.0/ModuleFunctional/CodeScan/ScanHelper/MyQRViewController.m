...
- (void)createQR1
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:@"" size:_qrImgView.bounds.size];
...
- (void)createQR2
{
    ...
    UIImage *image = [LBXScanWrapper createQRWithString:@"" size:_qrImgView.bounds.size];
    //二维码上色
...
- (void)createQR3
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:@""
...
- (void)createCodeEAN13
{
    ...
    _tImgView.image = [LBXScanWrapper createCodeWithString:@"" size:_qrImgView.bounds.size CodeFomart:AVMetadataObjectTypeEAN13Code];
}
...
- (void)createCode93
{
    ...
    //支付宝付款码-条款码
    _tImgView.image = [LBXScanWrapper createCodeWithString:@"" size:_qrImgView.bounds.size CodeFomart:AVMetadataObjectTypeCode128Code];
}
