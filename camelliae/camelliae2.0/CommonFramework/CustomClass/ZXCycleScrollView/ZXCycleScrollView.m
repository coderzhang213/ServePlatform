...
-(void)setUpUI{
    ...
    self.leftIV.layer.cornerRadius = 30*Proportion;
    ...
    self.centerIV.layer.cornerRadius = 30*Proportion;
    ...
    self.rightIV.layer.cornerRadius = 30*Proportion;
...
- (void)setInfoByCurrentImageIndex:(NSUInteger)currentImageIndex {
    ...
    if([self isHttpString:self.sourceDataArr[currentImageIndex]]){
        [NetWorkTask setImageView:self.centerIV WithURL:self.sourceDataArr[currentImageIndex] placeholderImage:self.placeHolderImage];
//        [self.centerIV sd_setImageWithURL:[NSURL URLWithString:self.sourceDataArr[currentImageIndex]] placeholderImage:self.placeHolderImage];
   ...
   if([self isHttpString:self.sourceDataArr[leftIndex]]){
       [NetWorkTask setImageView:self.leftIV WithURL:self.sourceDataArr[leftIndex] placeholderImage:self.placeHolderImage];
//        [self.leftIV sd_setImageWithURL:[NSURL URLWithString:self.sourceDataArr[leftIndex]] placeholderImage:self.placeHolderImage];
    ...
    if([self isHttpString:self.sourceDataArr[rightIndex]]){
        [NetWorkTask setImageView:self.rightIV WithURL:self.sourceDataArr[rightIndex] placeholderImage:self.placeHolderImage];
