...
@interface CMLServePriceVC ()<NavigationBarProtocol,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation CMLServePriceVC
...
- (void) output{
        ...
        if (self.costNumTextField.text.length > 0 && self.costNumTextField.text.length < 3) {
            ...
            [self.servePriceDelegate outputTicketPrice:[self.costPriceTextField.text intValue] andNum:[self.costNumTextField.text intValue]];
            [[VCManger mainVC] dismissCurrentVC];
