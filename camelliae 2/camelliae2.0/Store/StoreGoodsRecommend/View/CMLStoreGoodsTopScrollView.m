...
@interface CMLStoreGoodsTopScrollView ()<UIScrollViewDelegate>
...
@end
@implementation CMLStoreGoodsTopScrollView
...
- (void)loadViews {
    ...
    if (self.obj.retData.dataList.count == 0 ) {
        ...
        for (int i = 0; i < self.obj.retData.dataList.count; i++) {
            ...
            moduleImage.backgroundColor = [UIColor CMLBrownColor];
