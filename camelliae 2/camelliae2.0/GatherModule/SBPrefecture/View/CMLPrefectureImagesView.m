...
//    if ([self.obj.retData.picInfoModule.dataCount intValue]) {
//        
//    }
...
- (void) enterImageShowVC{
    ...
    CMLAllImagesVC *vc = [[CMLAllImagesVC alloc] initWithAlbumId:obj.parentAlbumId ImageName:self.obj.retData.picInfoModule.dataInfo.ModuleName];
